...
> **Status:** Confirmed learning direction; brainstorming stage  
...
First language for the toy ledger, target chain for contract learning, repo boundaries, and first hub integration.

## Next Action

Choose the toy-ledger implementation language and define the exact learning outcomes before selecting a smart-contract stack.
